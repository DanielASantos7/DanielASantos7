...
* **SPSKILLS:** Ecossistema .NET (C#, Web API, Entity Framework, .NET MAUI).
* **SENAI:** Ecossistema JavaScript/TypeScript (Node.js, React).
...
![.NET 8/9](https://img.shields.io/badge/.NET_8%2F9-512BD4?style=for-the-badge&logo=dotnet&logoColor=white)
...
<br>
![SQL Server](https://img.shields.io/badge/SQL_Server-CC2927?style=for-the-badge&logo=microsoft-sql-server&white)
